...
@error('judul') is-invalid @enderror" id="judul" placeholder="Judul" name="judul" value="{{old('judul')}}">
                    ...
                    <div class="input-group flex-nowrap">
                        ...
                        <textarea type="text" class="form-control border-success"
                            name="berita">{{old('berita')}}</textarea>
                    ...
                    <div class="input-group flex-nowrap">
                        ...
                        <input type="datetime-local" class="form-control border-warning"
...
@error('kategori_berita') is-invalid @enderror" placeholder="Kategori berita" id="kategori_berita"
                                name="kategori_berita" value="{{old('kategori_berita')}}" arialabel="kategori_berita"
                        ...
                        <div class="form-group">
                            ...
                            <img src="/img/no-image.png" class="imgthumbnail d-block" name="tampil" alt="..."
                                width="15%" id="tampil">
                            <input class="form-control @error('foto') isinvalid @enderror border-info" type="file"
                                id="foto" name="foto">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="staticBackdropLabel">
                                <font color="#000000">Pencarian Data Kategori Berita</font>
                            </h1>
                            <button type="button" class="btn-close btn-danger" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <table class="table table-hover table-bordered table-stripped border-danger" id="example2">
                                <thead>
