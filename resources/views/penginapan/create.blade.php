...
@error('fasilitas') is-invalid @enderror" id="fasilitas" placeholder="Fasilitas" name="fasilitas"
                    ...
                    <div class="form-group">
                        ...
                        <img src="/img/no-image.png" class="imgthumbnail d-block" name="tampil1" alt="..." width="15%"
                            id="tampil1">
                        <input class="form-control @error('foto1') isinvalid @enderror border-success" type="file"
                            id="foto1" name="foto1">
                    ...
                    <div class="form-group">
                        ...
                        <img src="/img/no-image.png" class="imgthumbnail d-block" name="tampil2" alt="..." width="15%"
                            id="tampil2">
                        <input class="form-control @error('foto2') isinvalid @enderror border-info" type="file"
                            id="foto2" name="foto2">
                    ...
                    <div class="form-group">
                        ...
                        <img src="/img/no-image.png" class="imgthumbnail d-block" name="tampil3" alt="..." width="15%"
                            id="tampil3">
                        <input class="form-control @error('foto3') isinvalid @enderror border-warning" type="file"
                            id="foto3" name="foto3">
                    ...
                    <div class="form-group">
                        ...
                        <img src="/img/no-image.png" class="imgthumbnail d-block" name="tampil4" alt="..." width="15%"
                            id="tampil4">
                        <input class="form-control @error('foto4') isinvalid @enderror border-danger" type="file"
                            id="foto4" name="foto4">
