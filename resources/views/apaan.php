...
<body>
    ...
    <main id="main">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="row event-item">
                                <div class="col-lg-6">
                                    <a href="{{route('paketshow', $pkt->id)}}"><img src="{{'/storage/' .$pkt->foto1}}"
                                            class="img-fluid" alt=""></a>
                                </div>
                                <div class="col-lg-6 pt-4 pt-lg-0 content">
                                    <h3><a href="{{route('paketshow', $pkt->id)}}">{{$pkt->nama_paket}}</a></h3>
                                    <div class="price">
        ...
        <!-- ======= About Section ======= -->
        <section id="specials" class="about">
            <div class="container" data-aos="fade-up">
            <div class="section-title">
                    <h2>Berita</h2>
                    <p>Read Everything More</p>
                </div>
        ...
        <section id="chefs" class="chefs">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2>Obyek Wisata</h2>
                    <p>Wonderfull Place</p>
                </div>

                <div class="row">
                @foreach($obyek_wisata as $ob)                    
                <div class="col-lg-4 col-md-6">
                        <div class="member" data-aos="zoom-in" data-aos-delay="100">
                            <img src="storage/{{$ob->foto1}}" alt="">
                            <div class="member-info">
                                <div class="member-info-content">
                                    <h4><a href="{{ route('obyekshow', $ob->id) }}">{{$ob->nama_wisata}}</a></h4>
                                </div>
                            </div>
                        </div>
                    </div>
