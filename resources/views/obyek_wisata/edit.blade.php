...
@stop
@section('content')
<form action="{{route('obyek_wisata.update', $obyek_wisata)}}" method="post" enctype="multipart/form-data">
    @method('PUT')
    @csrf
    <div class="row">
        <div class="col-12">
...
@error('nama_wisata') is-invalid @enderror" id="nama_wisata" placeholder="Nama Wisata" name="nama_wisata"
                    ...
                    <div class="input-group flex-nowrap">
                        ...
                        <textarea type="text" class="form-control border-success"
                            name="deskripsi_wisata">{{$obyek_wisata->deskripsi_wisata ??old('deskripsi_wisata')}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="hidden" name="id_kategori_wisata" id="id_kategori_wisata"
                                value="{{$obyek_wisata->fkasta->id ??old('id_kategori_wisata')}}">
...
@error('kategori_wisata') is-invalid @enderror" placeholder="Kategori Wisata" id="kategori_wisata"
                                ...
                                value="{{$obyek_wisata->fkasta->kategori_wisata ??old('kategori_wisata')}}"
                                arialabel="kategori_wisata" aria-describedby="cari" readonly>
...
@error('fasilitas') is-invalid @enderror" id="fasilitas" placeholder="Fasilitas" name="fasilitas"
                                value="{{$obyek_wisata->fasilitas ??old('fasilitas')}}">
                        ...
                        <div class="form-group">
                            ...
                            <img src="/img/no-image.png" class="imgthumbnail d-block" name="tampil2" alt="..."
                                width="15%" id="tampil2">
                            <input class="form-control @error('foto2') isinvalid @enderror border-primary" type="file"
                                id="foto2" name="foto2">
                        ...
                        <div class="form-group">
                            ...
                            <img src="/img/no-image.png" class="imgthumbnail d-block" name="tampil4" alt="..."
                                width="15%" id="tampil4">
                            <input class="form-control @error('foto4') isinvalid @enderror border-warning" type="file"
                                id="foto4" name="foto4">
